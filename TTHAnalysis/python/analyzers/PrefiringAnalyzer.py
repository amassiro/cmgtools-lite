...
class PrefiringAnalyzer(Analyzer):
    ...
    def process(self, event):
        ...
        #print " PrefiringAnalyzer::  self.cfg_comp.isMC = " , self.cfg_comp.isMC
        
        if not self.cfg_comp.isMC: return True
        
        fluctuations = ['central','up','down']
        thePhotons = event.selectedPhotons
        #thePhotons = event.slimmedPhotons   # AM FIX
        #//Jets
        theJets = event.cleanJetsAll
        #theJets = event.slimmedJets   # AM FIX
        ...
        #print " event.prefiringweight = ", event.prefiringweight
